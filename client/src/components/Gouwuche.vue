  ...
  <div class="bigbox">
    <div v-if="products.length">
      <table width="1200px">
        <tr>
          <th>
            <input id="quanxuan" type="checkbox" v-model="isChecked" @change="change">
        ...
        <tr v-for="(pro,index) in products" :key="index">
          <td>
            <input class="xuanze" type="checkbox" :value="index" v-model="cb">
          </td>
          <td>
            <img class="img" :src="pro.img" alt>
            <span>{{pro.title}}</span>
          </td>
          <td class="qian">
            <span>￥：</span>
